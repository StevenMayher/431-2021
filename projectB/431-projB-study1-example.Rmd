---
title: "431 Project B Study 1 Example Report"
...
# Important Reminders from Dr. Love {.unnumbered}
...
library(broom); library(patchwork); library(magrittr)
...
sur15 %>%
  summarise(skew1 = (mean(r_diff) - median(r_diff))/sd(r_diff))
```
...
sur15_B %>% group_by(english) %>%
  summarise(skew1 = round((mean(bmi) - median(bmi))/sd(bmi), 3))
```
