...
- Here is [the PDF document containing the old questions, answer sketch and results]().
- Here is [the mitral.csv data set]() referred to in Questions 2-4. It's also available on our 431-data site.
