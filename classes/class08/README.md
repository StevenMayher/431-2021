...
1. **Minute Paper Feedback** [Feedback on the Minute Paper after Class 07 is now available](https://bit.ly/431-2021-min7-feedback).
    - Minute Papers are always due Wednesdays at noon. Late minute papers (1-12 hours late) receive 60% of available credit.
    - To review old Minute Papers or see those coming up, visit the [Minute Papers page](https://github.com/THOMASELOVE/431-2021/tree/main/minutepapers).
...
5. **Faceting** I will talk more about `facet_grid()` and `facet_wrap()` today and demonstrate these approaches regularly in future classes. Some additional information can be found at the following locations (also listed on Piazza): 
...
I [prepared a document](https://github.com/THOMASELOVE/431-2021/blob/main/quizzes/README.md#sample-quiz-five-old-quiz-questions) containing five old quiz questions, as well as an answer sketch for those five questions, and some information on results.
...
- [Go here to see more detailed information on Quiz 1](https://github.com/THOMASELOVE/431-2021/blob/main/quizzes/README.md#getting-help-during-a-quiz) and how it will work when you receive it at the end of this month.
- My best advice on preparing for Quiz 1 is to complete your [Project A proposal](https://thomaselove.github.io/431-2021-projectA/proposal.html).
