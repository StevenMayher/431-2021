...
- Sample Odds of A1c < 8 now if Never smoked = $\frac{34/161}{1 - (34/161)}$ = `r round_half_up((34/161)/(1-(34/161)), 3)`
- Sample Odds of A1c < 8 now if Current smoker = $\frac{17/165}{1 - (17/165)}$ = `r round_half_up((17/165)/(1-(17/165)), 3)`
...
Can we build a confidence interval for the population odds ratio for of COM given "early" as compared to "delayed" testing?
