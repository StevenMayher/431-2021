...
- The Examples & Tips pages contain information on samples and tips we’ve prepared to help you find your way through Project A, including a [sample proposal](https://thomaselove.github.io/431-2021-projectA/exampleA.html) that you'll use as a model for your work in the rest of September.
- In October, you'll move from the fundamental work with the data and the proposal towards a final portfolio of materials, which we'll discuss further in a few weeks.
