...
3. Project A Early Proposals are under review, and that will be complete by Wednesday. Look for results on [Canvas](https://canvas.case.edu). Here are [some thoughts on your titles](https://github.com/THOMASELOVE/431-2021/blob/main/classes/class13/projectAearly.md).
